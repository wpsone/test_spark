...
//        ssc.addStreamingListener(new OffsetListener(TypeHelper.toScalaImmutableMap(kafkaParams)));
//        //关键步骤二：使用数据平台提供的KafkaManager，根据偏移量获取数据
//        // 如果你是Java代码 调用createDirectStream
//        KafkaManager kafkaManager = new KafkaManager(TypeHelper.toScalaImmutableMap(kafkaParams));
